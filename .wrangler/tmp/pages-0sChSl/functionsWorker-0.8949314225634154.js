...
var onRequest = /* @__PURE__ */ __name(async (context2) => {
  const incomingUrl = new URL(context2.request.url);
  ...
  const forwardedRequest = new Request(targetUrl, {
    ...
    body: hasBody ? await context2.request.arrayBuffer() : void 0
  });
...
// ../.wrangler/tmp/pages-0sChSl/functionsRoutes-0.01880976448302918.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
