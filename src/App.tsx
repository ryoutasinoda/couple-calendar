...
type Member = 'me' | 'wife'
type EventIcon = 'calendar' | 'hospital' | 'heart' | 'work' | 'shopping' | 'other'
...
function normalizeEvents(value: unknown): Event[] {
  ...
  return value.map((event, index) => ({
    ...
    member: event.member === 'wife' ? 'wife' : 'me',
    ...
    <div className="app">
      ...
      <main className="calendar-container">
        ...
        <div className="legend">
          ...
          <span className="legend-hint">日付をダブルクリックして予定を追加</span>
        </div>
      </main>
          ...
          <div className="modal" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="form-group">
              ...
              <div className="member-select">
                <button type="button" className={eventMember === 'me' ? 'selected me' : ''} onClick={() => setEventMember('me')}>自分</button>
                <button type="button" className={eventMember === 'wife' ? 'selected wife' : ''} onClick={() => setEventMember('wife')}>妻</button>
              </div>
            </div>
            ...
            <div className="modal-actions">
              ...
              <div className="modal-actions-right">
                <button type="button" className="cancel-button" onClick={closeModal}>キャンセル</button>
